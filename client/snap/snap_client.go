...
// New creates a new snap API client.
...
/*
SwapPlugins unloads an existing plugin then loads a new plugin
*/
func (a *Client) SwapPlugins(params *SwapPluginsParams) (*SwapPluginsCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewSwapPluginsParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "swapPlugins",
		Method:             "POST",
		PathPattern:        "/plugins/{ptype}/{pname}/{pversion}/swap",
		ProducesMediaTypes: []string{"application/json", "application/x-protobuf", "multipart/form-data"},
		ConsumesMediaTypes: []string{"application/json", "application/x-protobuf", "multipart/form-data"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &SwapPluginsReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	return result.(*SwapPluginsCreated), nil
